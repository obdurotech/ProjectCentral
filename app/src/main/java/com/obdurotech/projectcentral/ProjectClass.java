...
/**
 * Created by Sandesh Ashok Naik on 4/10/2017.
 */
...
public class ProjectClass {
    ...
    ProjectsAdapter myFirebaseRecylerAdapter;
    Context mContext;

    public void setAdapter(ProjectsAdapter mAdapter) {
        myFirebaseRecylerAdapter = mAdapter;
    }

    public void removeItemFromServer(Project project){
        if(project!=null){
    ...
    public ProjectClass(String userID){

        uid = userID;
        projectList = new ArrayList<>();
        mRef = FirebaseDatabase.getInstance().getReference().child("userdata").child(uid).child("projects").getRef();
